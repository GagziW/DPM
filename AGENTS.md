...
- **Firestore parity.** New field on `Challenge` / `User` → update iOS model + cloud functions + `DPM.org/lib/types/` + Android model + `docs/CONTRACT.md` (the `add-shared-field` skill walks all of it).
